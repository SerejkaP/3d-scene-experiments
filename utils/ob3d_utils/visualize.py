...
from utils.ob3d_utils.eval_depth import read_exr_depth_v2
from utils.ob3d_utils.eval_normal import read_exr_normal
...
def visualize_normal_conparison(
    normal_map1, normal_map2, description1=None, description2=None
):
    plt.figure(figsize=(12, 6))
    plt.subplot(1, 2, 1)
    if description1 is not None:
